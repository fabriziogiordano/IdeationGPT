...
GOAL:
Return 5 possible solutions for the target audience segment. These solution need to be built as profitable one-person business.
...
RESPONSE FORMAT:
Generate a table with 4 columns:
1. solution: description of the solution using at least 200 words
2. features: list of top 5 features of the solution separated by <br>
3. competitors: list of competitor names separated by comma
4. differentiator: description of key differentiators from the competitors
`;
